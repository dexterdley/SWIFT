...
for MODEL_DIR in ./checkpoints/deepseek-vl-7b-finetune-vord0-max-mix/v0-20250307-184642/checkpoint-9662/ ./checkpoints/deepseek-vl-7b-finetune-vord2-max-mix/v0-20250308-130307/checkpoint-9662/
do
    echo $MODEL_DIR
